 ...
 * configuration file. N.B. - W3TC assumes that the ordered list of JavaScript
 * files for a template is fixed. If your web pages are dynamically computing the
 * JavaScript files and two different web pages using the same template compute
 * different lists of JavaScript files then W3TC cannot be used to minify those
 * JavaScript files.
 * 
